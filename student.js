...
function setup() {
    ...
    // Load the model
    classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/OBXMqg6abF/', modelLoaded);
}
...
function gotResult(results, error) {
    ...
    if (label.includes('alisha')) {
        resultDiv.innerHTML = "Welcome alisha";
